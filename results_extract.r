...
hydOut <- read.csv("c:\\Users\\hkropp\\Google Drive\\hydrus\\hydrus\\runs\\run_final\\all_fix_out\\Obs_Node_out.csv")
...
plot(swcOut$depth60[swcOut$year==2016], type="l", col="cornflowerblue")

write.table(swcOut,
			"c:\\Users\\hkropp\\Google Drive\\hydrus\\hydrus\\runs\\run_final\\all_fix_out\\VWC_soil_out.csv",
			sep=",", row.names=FALSE)